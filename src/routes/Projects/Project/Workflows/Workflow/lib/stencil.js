...
(() => {
  ...
  window.App.config.stencil = {};

  window.App.config.stencil.groups = {
  ...
  window.App.config.stencil.shapes = {};

  window.App.config.stencil.shapes.basic = [
    {
      type: 'basic.Rect',
  ...
  window.App.config.stencil.shapes.fsa = [
  ...
  window.App.config.stencil.shapes.pn = [
  ...
  window.App.config.stencil.shapes.erd = [
  ...
  window.App.config.stencil.shapes.uml = [
  ...
  window.App.config.stencil.shapes.org = [
