...
export class ProjectDetail extends Component {
  static propTypes = {
    ...
    projectRequesting: PropTypes.bool.isRequired,
  };
  ...
  render() {
    const {
      formatMessage,
      match: { url, params: { projectId } },
      project,
      projectRequesting,
    } = this.props;
    const projectName = projectRequesting ? '--' : project.getIn(['attributes', 'name']) || '--';
    return (
      <div>
...
export default connect(mapStateToProps, mapDispatchToProps)(injectIntl(ProjectDetail));
